        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Rolcu</div>
                    <div class="panel-body">
                        <a href="{{ url('/rol-cu/create') }}" class="btn btn-success btn-sm" title="Add New RolCu">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/rol-cu', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $rolcu->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
